        ...
        <div className='p-6'>
              {tasks?.length>0?(<div className='overflow-x-auto'>
                         <table className='min-w-full divide-y divide-gray-200'>
                            ...
                            <tbody className='bg-hite divide-y divide-gray-200'>
                           {
                            tasks.map((task)=>(
                                <tr key={task._id} className='hover:bg-gray-500'>
                                    <td className='px-6 py-4 whitespace-nowrap'>
                                     ...
                                     <td className='px-6 py-4 whitespace-nowrap'>
                                        ...
                                        task.status === "Completed"?"bg-green-100 text-green-800":task.status === "Pending" ? "bg-yellow-100 text-yellow-800" :"bg-blue-100 text-blue-800"
                                        }`}>
                                         {task.status}
                                        </span>
                                    </td>
